...
class IndexSpider(object):
    ...
    def cal_volume_ratio(self, source_data_dict):
        ...
        volume_ratio_dict['888888'] = map(
            ...
            volume_ratio_dict['000001'], volume_ratio_dict['399001'],
            volume_ratio_dict['399300'], volume_ratio_dict['399005'],
            volume_ratio_dict['399006'], volume_ratio_dict['399905'])
    ...
    def index_profitAndloss(self, source_data_dict):
        ...
        profitAndloss['888888'] = map(
            ...
            profitAndloss['000001'], profitAndloss['399001'],
            profitAndloss['399300'], profitAndloss['399005'],
            profitAndloss['399006'], profitAndloss['399905'])
    ...
    def long_short_trend(self, source_data_dict):
        ...
        ls_trend['888888'] = map(
            ...
            ls_trend['000001'], ls_trend['399001'],
            ls_trend['399300'], ls_trend['399005'],
            ls_trend['399006'], ls_trend['399905'])
        return ls_trend
...
def create_profitAndloss_content(index_profitAndloss):
    index_dict = {'000001': u'上证盈亏', '399001': u'深圳盈亏',
                  '399300': u'沪深盈亏', '399005': u'中小盈亏',
                  '399006': u'创业盈亏', '399905': u'中证盈亏',
                  '888888': u'平均盈亏'}
...
def create_lstrend_content(ls_trend):
    index_dict = {'000001': u'上证多空', '399001': u'深圳多空',
                  '399300': u'沪深多空', '399005': u'中小多空',
                  '399006': u'创业多空', '399905': u'中证多空',
                  '888888': u'综合多空'}
...
if __name__ == '__main__':
    ...
    for i in ['000001', '399001', '399300', '399005', '399006', '399905']:
    ...
    send_mail(mailto_list,  u'大盘量比', volume_ratio_mail_content)
    ...
    send_mail(mailto_list,  u'市场盈亏', profitAndloss_content)
    ...
    send_mail(mailto_list,  u'多空对比', ls_trend_content)
